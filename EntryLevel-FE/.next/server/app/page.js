...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 23367)), "/Users/duckhango/Documents/EntryLevel-BE-KhaNgo/EntryLevel-FE/src/app/page.tsx"],
          metadata: {
    ...
    manifest: undefined
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 64180)), "/Users/duckhango/Documents/EntryLevel-BE-KhaNgo/EntryLevel-FE/src/app/layout.tsx"],
          metadata: {
    icon: [(async (props) => (await Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 41764))).default(props))],
    apple: [],
    openGraph: [],
    ...
    const pages = ["/Users/duckhango/Documents/EntryLevel-BE-KhaNgo/EntryLevel-FE/src/app/page.tsx"];
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 23982))
...
;// CONCATENATED MODULE: ./src/components/CardImage/index.tsx



function CardImage(imageInfo) {
    return /*#__PURE__*/ jsx_runtime_.jsx(node.Card, {
        sx: {
            minWidth: 200
        },
        children: /*#__PURE__*/ jsx_runtime_.jsx(node.CardContent, {
            children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)(node.Stack, {
                spacing: 1,
                children: [
                    /*#__PURE__*/ jsx_runtime_.jsx("img", {
                        src: imageInfo.thumbnail_img_url,
                        alt: "#"
                    }),
                    /*#__PURE__*/ jsx_runtime_.jsx(node.Typography, {
                        ...
                        children: /*#__PURE__*/ jsx_runtime_.jsx("b", {
                            children: imageInfo.display_title
                        })
                    }),
                    /*#__PURE__*/ jsx_runtime_.jsx(node.Typography, {
                        sx: {
                        ...
                        gutterBottom: true,
                        children: `${moment_default()(imageInfo.start_date).format("DD MMM")} - ${moment_default()(imageInfo.end_date).format("DD MMM")}`
                    })
                ]
            })
        })
...
var HighlightOff = __webpack_require__(99185);
;// CONCATENATED MODULE: ./src/components/ClearableSelect/index.tsx




function ClearableSelect({ label , value , onChange , onClear , options  }) {
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)(node.FormControl, {
        fullWidth: true,
        children: [
            ...
            /*#__PURE__*/ jsx_runtime_.jsx(node.Select, {
                ...
                endAdornment: /*#__PURE__*/ jsx_runtime_.jsx(node.IconButton, {
                    sx: {
                        visibility: value ? "visible" : "hidden"
                    },
                    onClick: onClear,
                    children: /*#__PURE__*/ jsx_runtime_.jsx(HighlightOff/* default */.Z, {})
                }),
...
(function(ESessionStatus) {
    ESessionStatus["OFFERING"] = "OFFERING";
    ESessionStatus["RUNNING"] = "RUNNING";
    ESessionStatus["OFFBOARDING"] = "OFFBOARDING";
})(ESessionStatus || (ESessionStatus = {}));
var EProductShortTitle;
(function(EProductShortTitle) {
    EProductShortTitle["vc"] = "vc";
    EProductShortTitle["product"] = "product";
    EProductShortTitle["data"] = "data";
    EProductShortTitle["data2"] = "data2";
    EProductShortTitle["data3"] = "data3";
    EProductShortTitle["scrum"] = "scrum";
    EProductShortTitle["product2"] = "product2";
    EProductShortTitle["growth"] = "growth";
})(EProductShortTitle || (EProductShortTitle = {}));

;// CONCATENATED MODULE: ./src/app/FilterBar.tsx




function FilterBar({ filterState , onSubmit  }) {
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)(node.Stack, {
        direction: "row",
        spacing: 2,
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx(node.Box, {
                ...
                children: /*#__PURE__*/ jsx_runtime_.jsx(ClearableSelect, {
                    label: "Short Title",
                    value: filterState.shortTitle,
                    options: Object.keys(EProductShortTitle).map((x)=>({
                            value: EProductShortTitle[x],
                            label: x
                        })),
                    onChange: (e)=>{
                        onSubmit({
            ...
            /*#__PURE__*/ jsx_runtime_.jsx(node.Box, {
                ...
                children: /*#__PURE__*/ jsx_runtime_.jsx(ClearableSelect, {
                    ...
                    options: Object.keys(ESessionStatus).map((x)=>({
                            value: ESessionStatus[x],
                            label: x
                        })),
                    onChange: (e)=>onSubmit({
                            ...filterState,
...
/* harmony default export */ const app_FilterBar = (FilterBar);
...
function Home() {
    const [programItems, setProgramItems] = (0,react_.useState)([]);
    const [filterState, setFilterState] = (0,react_.useState)({
        shortTitle: null,
        status: null
    });
    ...
    (0,react_.useEffect)(()=>{
        setLoading(true);
        fetchSessions(filterState.shortTitle, filterState.status).then((res)=>{
            const programs = res.data.data.map((t)=>t.program.map((p)=>{
                    return {
                        ...p,
    ...
    return /*#__PURE__*/ jsx_runtime_.jsx(node.Container, {
        children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)(node.Stack, {
            ...
            spacing: 2,
            children: [
                /*#__PURE__*/ jsx_runtime_.jsx(app_FilterBar, {
                ...
                /*#__PURE__*/ jsx_runtime_.jsx(node.Box, {
                    ...
                    children: loading && /*#__PURE__*/ jsx_runtime_.jsx(node.LinearProgress, {})
                }),
                /*#__PURE__*/ jsx_runtime_.jsx(node.Grid, {
                    flexWrap: "wrap",
                    spacing: 2,
                    container: true,
                    children: programItems.map((t)=>{
                        return /*#__PURE__*/ jsx_runtime_.jsx(node.Grid, {
                            item: true,
                            xs: 4,
                            sm: 4,
                            md: 3,
                            children: /*#__PURE__*/ (0,react_.createElement)(CardImage, {
                                ...t,
                                key: t.id
                            })
                        });
...
/* harmony import */ var next_font_google_target_css_path_src_app_layout_tsx_import_Inter_arguments_subsets_latin_variableName_inter___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(48450);
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`/Users/duckhango/Documents/EntryLevel-BE-KhaNgo/EntryLevel-FE/src/app/page.tsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [859,55], () => (__webpack_exec__(16128)));
